          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                // Add this Align widget for the "Forgot Password?" link
                Align(
...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  // 0: Email entry, 1: Code verification, 2: New password
  int _currentStep = 0;
  String? _resetCode;
  ...
  Future<void> _requestResetCode() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        setState(() {
          _currentStep = 1;
          // In a real app, you wouldn't store this in the app
          // It's just for testing purposes
          _resetCode = codeFromServer;
        });

        // Show the code in a snackbar for testing
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text('Verification code: ${_resetCode ?? "Check your email"}'),
  ...
  Future<void> _verifyCode() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        // For testing, we can directly compare with the stored code
        if (_resetCode != null && _codeController.text == _resetCode) {
          setState(() {
            _currentStep = 2;
          });
        } else {
          // In production, verify with the backend
